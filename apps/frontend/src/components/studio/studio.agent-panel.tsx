    ...
    <div className="w-[320px] shrink-0 bg-newBgColor border-l border-newBorder flex flex-col h-full">
      <div className="flex items-center justify-between px-[16px] py-[12px] border-b border-newBorder">
        ...
        <button
          type="button"
          onClick={onClose}
          className="text-textItemBlur hover:text-btnText text-[18px] leading-none"
      ...
      <div className="p-[12px] border-t border-newBorder">
        ...
        <div className="flex gap-[8px]">
          <input
            ...
            className="flex-1 h-[40px] px-[12px] rounded-[8px] bg-newBgColorInner border border-newBorder text-[13px] text-btnText placeholder:text-textItemBlur disabled:opacity-60"
          />
          <button
            type="button"
            disabled
